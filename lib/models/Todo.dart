...
class Todo extends amplify_core.Model {
  ...
  const Todo._internal({required this.id, title, descrip, createdAt, updatedAt})
      : _title = title,
        _descrip = descrip,
        _createdAt = createdAt,
        _updatedAt = updatedAt;

  factory Todo({String? id, String? title, String? descrip}) {
  ...
  Todo copyWith({String? title, String? descrip}) {
    return Todo._internal(
        id: id, title: title ?? this.title, descrip: descrip ?? this.descrip);
  }

  Todo copyWithModelFieldValues(
      {ModelFieldValue<String?>? title, ModelFieldValue<String?>? descrip}) {
    return Todo._internal(
        id: id,
        title: title == null ? this.title : title.value,
        descrip: descrip == null ? this.descrip : descrip.value);
  }

  Todo.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        _title = json['title'],
        _descrip = json['descrip'],
  ...
  static final DESCRIP = amplify_core.QueryField(fieldName: "descrip");
